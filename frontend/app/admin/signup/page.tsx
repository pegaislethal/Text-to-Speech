      ...
      <div className="md:w-1/2 p-8 md:p-16 flex flex-col items-center justify-center relative bg-[#070708]">
        <div className="w-full max-w-md flex flex-col gap-8">
          <div className="flex flex-col gap-2">
            ...
            <p className="text-xs text-neutral-400 font-medium">Fill in credentials to register an administrator profile.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="p-8 rounded-2xl border border-neutral-900 bg-neutral-950/60 backdrop-blur-xl shadow-2xl flex flex-col gap-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="mt-3 w-full py-3.5 rounded-xl bg-gradient-to-r from-violet-600 to-indigo-600 hover:from-violet-500 hover:to-indigo-500 text-xs font-bold text-white shadow-lg shadow-violet-500/20 disabled:opacity-50 transition active:scale-98 flex items-center justify-center gap-2"
            >
