    ...
    <div className="min-h-screen bg-background flex flex-col md:flex-row text-foreground selection:bg-indigo-50 selection:text-white transition-colors duration-200">
      ...
      <div className="md:w-1/2 p-8 md:p-16 flex flex-col items-center justify-center relative bg-background border-t md:border-t-0 border-[var(--border-app)]">
        <div className="w-full max-w-md flex flex-col gap-8">
          ...
          <form onSubmit={handleSubmit} className="p-8 rounded-2xl border border-[var(--border-app)] bg-[var(--bg-card)]/60 backdrop-blur-xl shadow-2xl flex flex-col gap-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="mt-2 w-full py-3.5 rounded-xl bg-gradient-to-r from-violet-600 to-indigo-600 hover:from-violet-500 hover:to-violet-500 text-xs font-bold text-white shadow-lg shadow-violet-500/20 disabled:opacity-50 transition active:scale-98 flex items-center justify-center gap-2 cursor-pointer"
            >
